...
const { createProduct, getAllProducts,getProductById, addToCart,getCart,updateCart,removeFromCart,getProductsByCategory} = require('../controller/productController');
const router = Router();
