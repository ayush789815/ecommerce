        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <div>
              ...
              <p className="text-gray-600">Email: ayushvishwakarmaa612@gmail.com</p>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full bg-gray-50 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                />
                <input
                  type="email"
